        ...
        return (
            <Grid className={classes.sideBySideHeaderSecond}>
                <Grid className={classes.sideBySideHeader}>
                    ...
                    <Typography variant="h6" component="h3" className="headerTypography" className={classes.headerTypography}>
                        头部节点
                        <Typography component="p" className={classes.headerTypography}>
                ...
                <Grid className={classes.sideBySideHeader}>
                    ...
                    <Typography variant="h6" component="h2" className="headerTypography" className={classes.headerTypography}>
                        区块高度
                        <Typography component="p" className={classes.headerTypography}>
                ...
                <Grid className={classes.sideBySideHeader}>
                    ...
                    <Typography variant="h6" component="h2" className="headerTypography" className={classes.headerTypography}>
                        最近更新
                        <Typography component="p" className="headerTypographyLast" className={classes.headerTypography}>
